...
## Maps {.tabset}
The maps below show the optimal road network in the baseline scenario and highlight links by importance ranking, by scenario cost, or by change in scenario cost from the previous disruption step.
...
### By Total Cost
The top ranked links for importance are removed from the network one-by-one in subsequent disruption scenarios. The map below plots the optimal road links in the baseline scenario and highlights each link removed based on the resulting scenario cost in the associated disruption scenario.
