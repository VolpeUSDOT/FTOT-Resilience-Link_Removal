...
cat('Note: This scenario includes "high importance" edges that flow more than one commodity. As a result, multiple disruption scenarios were created and run for the same road edges. 
')
